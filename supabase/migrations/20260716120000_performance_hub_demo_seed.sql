-- Performance Hub UAT demo seed (auto-applied migration)
-- Source: docs/performance-hub/PERFORMANCE_HUB_DEMO_DATA.md §4 + §4.4
-- Idempotent; re-run manually: SELECT public.fn_seed_performance_hub_demo();
