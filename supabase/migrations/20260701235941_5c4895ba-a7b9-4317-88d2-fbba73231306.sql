...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.upi_commission_remittance_batch_statements TO authenticated;
GRANT ALL ON public.upi_commission_remittance_batch_statements TO service_role;
