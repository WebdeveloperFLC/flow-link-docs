...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.qualification_application_references TO authenticated;
GRANT ALL ON public.qualification_application_references TO service_role;
