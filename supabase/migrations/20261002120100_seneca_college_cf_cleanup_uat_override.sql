-- UAT override: idempotent cleanup if 20261002120000 failed on finalized-program guard.
-- Safe to run when Seneca College CF row still exists; no-op if already merged.
