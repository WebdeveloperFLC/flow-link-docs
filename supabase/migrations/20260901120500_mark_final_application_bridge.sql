-- Mark Final → Auto-create Application bridge (Phase B/C)
-- Course Finder stays under Client Services; Applications tab unchanged in scope.
...
COMMENT ON FUNCTION public.fn_mark_final_and_create_application IS
