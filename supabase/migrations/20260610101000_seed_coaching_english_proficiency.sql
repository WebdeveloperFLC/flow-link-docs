...
SELECT
  (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_checklist_files cf
  WHERE cf.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1)
...
INSERT INTO public.service_library_checklist_files
  (library_id, file_name, file_path, mime_type, size_bytes, version, is_current, notes)
SELECT
  (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_checklist_files cf
  WHERE cf.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1)
...
INSERT INTO public.service_library_checklist_files
  (library_id, file_name, file_path, mime_type, size_bytes, version, is_current, notes)
SELECT
  (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_checklist_files cf
  WHERE cf.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1)
...
INSERT INTO public.service_library_checklist_files
  (library_id, file_name, file_path, mime_type, size_bytes, version, is_current, notes)
SELECT
  (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_checklist_files cf
  WHERE cf.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1)
...
INSERT INTO public.service_library_checklist_files
  (library_id, file_name, file_path, mime_type, size_bytes, version, is_current, notes)
SELECT
  (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_checklist_files cf
  WHERE cf.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1)
...
SELECT (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1), x.item_key, x.item_label, x.is_mandatory, x.sort_order, true
FROM (VALUES
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  ...
  WHERE c.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'PTE Academic' AND sub_service = 'English Proficiency' LIMIT 1) AND c.item_key = x.item_key
);

-- Submission checklist — TOEFL iBT
INSERT INTO public.service_library_submission_checklist
  (library_id, item_key, item_label, is_mandatory, sort_order, is_active)
SELECT (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1), x.item_key, x.item_label, x.is_mandatory, x.sort_order, true
FROM (VALUES
  ('diagnostic_completed', 'Diagnostic / level assessment completed', true, 1),
  ('enrollment_agreement_signed', 'Enrollment agreement signed', true, 2),
  ('course_fee_collected', 'Course fee collected; receipt issued', true, 3),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_submission_checklist c
  WHERE c.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'TOEFL iBT' AND sub_service = 'English Proficiency' LIMIT 1) AND c.item_key = x.item_key
);

-- Submission checklist — CELPIP General
INSERT INTO public.service_library_submission_checklist
  (library_id, item_key, item_label, is_mandatory, sort_order, is_active)
SELECT (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1), x.item_key, x.item_label, x.is_mandatory, x.sort_order, true
FROM (VALUES
  ('diagnostic_completed', 'Diagnostic / level assessment completed', true, 1),
  ('enrollment_agreement_signed', 'Enrollment agreement signed', true, 2),
  ('course_fee_collected', 'Course fee collected; receipt issued', true, 3),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_submission_checklist c
  WHERE c.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'CELPIP General' AND sub_service = 'English Proficiency' LIMIT 1) AND c.item_key = x.item_key
);

-- Submission checklist — Duolingo English Test
INSERT INTO public.service_library_submission_checklist
  (library_id, item_key, item_label, is_mandatory, sort_order, is_active)
SELECT (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1), x.item_key, x.item_label, x.is_mandatory, x.sort_order, true
FROM (VALUES
  ('diagnostic_completed', 'Diagnostic / level assessment completed', true, 1),
  ('enrollment_agreement_signed', 'Enrollment agreement signed', true, 2),
  ('course_fee_collected', 'Course fee collected; receipt issued', true, 3),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_submission_checklist c
  WHERE c.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Duolingo English Test' AND sub_service = 'English Proficiency' LIMIT 1) AND c.item_key = x.item_key
);

-- Submission checklist — Spoken English (with books)
INSERT INTO public.service_library_submission_checklist
  (library_id, item_key, item_label, is_mandatory, sort_order, is_active)
SELECT (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1), x.item_key, x.item_label, x.is_mandatory, x.sort_order, true
FROM (VALUES
  ('diagnostic_completed', 'Diagnostic / level assessment completed', true, 1),
  ('enrollment_agreement_signed', 'Enrollment agreement signed', true, 2),
  ('course_fee_collected', 'Course fee collected; receipt issued', true, 3),
...
WHERE (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1) IS NOT NULL
  AND NOT EXISTS (
  SELECT 1 FROM public.service_library_submission_checklist c
  WHERE c.library_id = (SELECT id FROM public.service_library WHERE service_category = 'coaching_services' AND service = 'Spoken English (with books)' AND sub_service = 'English Proficiency' LIMIT 1) AND c.item_key = x.item_key
);
