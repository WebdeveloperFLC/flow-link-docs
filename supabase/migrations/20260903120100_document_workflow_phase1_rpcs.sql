...
-- Template assignment, requirement materialization, portal ingest
...
BEGIN
  ...
  -- category = full service_code or bare library id (legacy)
...
-- ---------------------------------------------------------------------------
-- Assign template to case + materialize overlay requirements from base template
-- ---------------------------------------------------------------------------
...
BEGIN
  ...
  -- Flat items not referenced by any group (legacy templates)
  FOR v_item IN SELECT * FROM jsonb_array_elements(v_items)
  LOOP
...
-- ---------------------------------------------------------------------------
-- Manual add requirement (Add Document from master)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Portal ingest → single client_documents row
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Backfill: materialize requirements for open cases with templates
-- ---------------------------------------------------------------------------
DO $$
DECLARE
  r record;
