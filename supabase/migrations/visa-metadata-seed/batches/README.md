...
| finland | `batches/batch-finland.sql` | 3 | 190.4 KB |
...
| hungary | `batches/batch-hungary.sql` | 4 | 259.5 KB |
| ireland | `batches/batch-ireland.sql` | 2 | 132.2 KB |
| italy | `batches/batch-italy.sql` | 2 | 126.2 KB |
| latvia | `batches/batch-latvia.sql` | 3 | 190.3 KB |
...
| poland | `batches/batch-poland.sql` | 4 | 260.3 KB |
| portugal | `batches/batch-portugal.sql` | 2 | 127.6 KB |
| singapore | `batches/batch-singapore.sql` | 4 | 246.9 KB |
