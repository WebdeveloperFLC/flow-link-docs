-- Knowledge Centre — server-side guide import (atomic, SECURITY DEFINER)
-- Maps GuideImportPayload JSON into kc_* tables (sections, FAQs, quiz, downloads, sources, links).
...
BEGIN
  ...
  -- Shared article stubs (Related Knowledge targets)
