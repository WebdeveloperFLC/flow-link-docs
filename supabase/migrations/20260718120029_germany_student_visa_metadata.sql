  ...
  academy_metadata = $metadata$
{
  ...
  "policyAlert": {
    "active": true,
    "date": "16 Jun 2026",
    "summary": "The blocked account amount (currently €11,904/year, €992/month) and the national visa fee (currently €75) are set/revised by the German Federal Foreign Office and can change — confirm current before quoting. APS is MANDATORY for Indian degree applicants >90 days (since 1 Nov 2022), with narrow exemptions only. Confirm all amounts on the mission's site (india.diplo.de / auswaertiges-amt.de) and the blocked-account provider; treat figures as current values, never publish invented statistics."
  },
  "alert": {
    "title": "APS certificate + funded blocked account are gating items",
    "body": "For Indian nationals applying for degree programs longer than 90 days, the APS certificate is MANDATORY (since 1 Nov 2022) — not optional. Narrow exemptions only: DAAD/EU-funded scholarship holders, some PhD cases where the supervisor waives it, and courses under 90 days. The blocked account (Sperrkonto) must be funded before lodging. Neither can be rushed — start both as soon as admission (Zulassung) is in view. Confirm current APS fee and processing time before promising any intake date."
  },
  "tags": [
    {
    ...
    {
      "label": "Processing varies — subject to government updates",
      "variant": "neutral"
    },
    {
  ...
  "kpis": [
    {
      ...
      "value": "6–12 weeks",
      "sub": "Processing time varies by mission + APS — subject to government updates",
      "tone": "primary"
    },
    {
      "label": "Government fee",
      "value": "€75 (€37.50 for minors)",
      "sub": "National Type D visa fee (paid in INR at VFS)",
      "tone": "warning"
    },
    {
      "label": "Approval rate",
      "value": null,
      "sub": "Pull from current CRM case data; not a prediction of any individual outcome",
      "tone": "primary"
    },
    {
      "label": "Required docs",
      "value": "Varies by profile",
      "sub": "Typically 12–18 documents — see current checklist",
      "tone": "violet"
    },
    {
      "label": "Consultancy fee",
      "value": "₹85,000 (public institutions) / ₹15,000 (private institutions)",
      "sub": "+ govt & third-party costs (quoted separately)",
      "tone": "primary"
    }
  ],
  "about": [
    ...
    },
    {
      ...
      "value": "University admission/Zulassung (or conditional admission / Studienkolleg place) · Funded blocked account (Sperrkonto) €11,904/year or accepted alternative · APS certificate (mandatory for Indian degree applicants >90 days) · Valid health insurance (travel + statutory/private student plan) · Motivation letter · Language proof per program (German/English)"
    },
    {
      "label": "Blocked account",
      "value": "Blocked account (Sperrkonto) of €11,904/year, released as €992/month after arrival, unless a scholarship or accepted alternative (e.g. Verpflichtungserklärung) applies. The amount is set annually by the Federal Foreign Office (BAföG-linked); it is the 12-month minimum and some missions require proof for the full program duration, with ~10% more for certain categories. The funds are the student's own money, not a fee. Subject to government updates — confirm the current amount before opening the account.",
      "warning": true
    },
    {
      "label": "Key authority",
  ...
  "eligibility": [
    ...
    },
    {
      ...
      "met": false,
      "note": "APS (Akademische Prüfstelle) is MANDATORY for Indian degree applicants >90 days (since 1 Nov 2022). Exemptions: DAAD/EU-funded scholarships, some PhD cases, sub-90-day courses. Fee and processing time are time-sensitive — subject to government updates. Book the visa appointment only once APS is in hand."
    },
    {
      "criterion": "Blocked account or financial proof",
      "met": false,
      "note": "Funded blocked account (Sperrkonto) of €11,904/year (released as €992/month after arrival) from an accepted provider, or an accepted alternative. 12-month minimum; some missions require the full program duration. Subject to government updates."
    },
    {
  ...
  "redFlags": [
    ...
    },
    {
      ...
      "fix": "Confirm Anabin/institution recognition before fees",
      "severity": "Common"
    },
    {
    ...
    },
    {
      ...
      "fix": "Confirm institution and degree recognition on Anabin before any fee; confirm the Zulassung is valid for the intended intake",
      "severity": "Common"
    },
    {
  ...
  "faqs": [
    ...
    {
      "q": "What is APS?",
      "a": "APS (Akademische Prüfstelle / Academic Evaluation Centre) verifies Indian academic documents. It is MANDATORY for all Indian nationals applying for degree programs longer than 90 days (since 1 Nov 2022) — the mission will not accept the visa application without it. Narrow exemptions: DAAD/EU-funded scholarships, some PhD cases, sub-90-day courses. The fee and processing time are time-sensitive (subject to government updates); book the visa appointment only once APS is in hand."
    },
    {
      "q": "How much must the blocked account hold?",
      "a": "The blocked account (Sperrkonto) must hold the Federal Foreign Office's current annual minimum (€11,904/year), released as €992/month after arrival. It is the 12-month minimum — some missions require proof for the full program duration, and certain categories require ~10% more. It is the student's own money, not a fee. Transfer slightly more than the minimum to absorb FX/fees. Subject to government updates — confirm the current amount before opening the account."
    },
    {
      "q": "Can spouse accompany?",
      "a": "Dependants (spouse/children) usually apply for family reunion separately and must show additional funds and suitable accommodation; a spouse's work access depends on the permit. Assess case-by-case and confirm current requirements with the mission."
    },
    {
    ...
    },
    {
      ...
      "a": "Eligible graduates may apply for an 18-month job-search residence permit (§20 Residence Act) OR use the Opportunity Card (Chancenkarte) — these are separate instruments with different eligibility criteria. Confirm the current rules and any thresholds before advising."
    },
    {
      "q": "How much is the German national (Type D) student visa fee?",
      "a": "The national (Type D) visa fee (€75 (€37.50 for minors), reduced for minors) is paid to the German mission in local currency, plus the blocked account (the student's own money, not a fee). Subject to government updates — confirm the current consular fee on the mission's site — it is set by the Foreign Office and converted to local currency."
    },
    {
      "q": "What health insurance is required?",
      "a": "A travel/incoming policy (minimum cover per the mission, commonly €30,000) to bridge the period before the semester starts, then statutory student insurance (e.g. TK/AOK/Barmer — premium €110–150/month, typically for under-30 students) or an accepted private plan. The public-vs-private choice is largely a one-way decision, so choose deliberately. Insurance proof is required for both the visa and the residence permit."
    },
    {
      "q": "What is the blocked account (Sperrkonto) and how does it work?",
      "a": "A regulated account holding the current annual minimum (€11,904/year), from which the set monthly amount (€992/month) is released after arrival, proving the student can cover living costs for a year. It is the student's own money, not a fee. FLC never receives or routes these funds — the student opens and funds it directly with an accepted provider as soon as admission is in view."
    },
    {
    ...
    {
      "q": "Is the blocked-account minimum enough to actually current on?",
  ...
  "compliance": [
    ...
    "Do not publish a firm approval rate or a comparative 'industry benchmark' as a headline figure — it can be read as a guarantee or as misleading advertising. Use current, sourced CRM data and label it as not predictive of any individual outcome.",
  ...
  "proTips": [
    ...
    "Confirm health insurance accepted by embassy",
    ...
    "Confirm institution/degree recognition on Anabin before any fee.",
    "Treat the €75 fee, €11,904 blocked amount and processing times as subject to government updates — confirm on the mission's site and pull from current CRM data.",
  ...
  "performance": {
    "ourRate": null,
    "industryRate": null,
    "note": "Approval rate and file counts must be populated from current CRM case data, not published as fixed figures. Do not display a comparative 'industry benchmark' unless it is independently sourced and cited.",
    "stats": [
      {
  ...
  "staffNotes": [
    {
      "author": "Service Library",
      "date": "16 Jun 2026",
      "text": "Values that change over time must be populated from current official sources / CRM before client use: national visa fee, blocked-account amount and monthly release, APS fee and processing time, processing times, health-insurance premiums, tuition (incl. Baden-Württemberg), minimum wage, and any approval/file-count figures. Never publish invented statistics or approval rates."
    },
    {
      "author": "Documentation team",
      "date": "16 Jun 2026",
      "text": "APS is mandatory for Indian degree applicants >90 days — never frame it as optional. Do not promise an intake without confirming the current APS timeline. Never receive or route a client's blocked-account funds."
    }
  ],
  "resources": [
    {
    ...
    },
    {
      ...
      "description": "Confirm institution recognition"
    },
    {
  ...
  "quiz": [
    ...
    },
    {
      ...
      "correctIndex": 1,
      "explanation": "The national visa fee is around €75; subject to government updates — confirm on the mission's site."
    },
    {
      "level": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "A refusal risk — confirm before any fee",
        "Irrelevant"
      ],
      "correctIndex": 2,
    ...
    },
    {
      ...
      "options": [
        "Confirm recognition before any fee; do not assume it is recognised",
        "Pay the fee anyway",
        "Ignore Anabin",
        "Guarantee approval"
      ],
    ...
    },
    {
      ...
      "correctIndex": 2,
      "explanation": "Do not publish firm rates or comparative benchmarks as headline claims; use current sourced data."
    },
    {
      "level": 2,
  ...
  "workingRights": {
    ...
    "spouse": {
      "summary": "A spouse on a family-reunion residence permit generally has labour-market access, but it depends on the permit wording and qualifications — confirm with the Ausländerbehörde.",
      "details": [],
      "restrictions": [],
  ...
  "fullCostBreakdown": {
    ...
    "disclaimer": "Indicative costs for counsellor discussions only. Some values are subject to government updates and should be confirmed against official sources before quoting (Federal Foreign Office / mission / blocked-account provider). The blocked account is the student's own money, not a fee. Most public universities charge no tuition; Baden-Württemberg charges non-EU students a per-semester tuition — confirm. INR equivalents move with exchange rates.",
        ...
        "items": [
          {
            ...
            "amount": "€75 (€37.50 for minors)",
            "currency": "EUR",
            "applicable": true,
            "notes": "Paid to the German mission; reduced for minors. Subject to government updates."
          },
          {
            ...
            "currency": "EUR",
            "applicable": true,
            "notes": "Monthly release €992/month after arrival. Student's own money, not a fee. Subject to government updates."
          },
          {
            "label": "Semester contribution",
            "range": "€100–350/semester",
            "unit": "per semester",
            "currency": "EUR",
            "applicable": true,
          ...
          },
          {
            ...
            "currency": "INR/EUR",
            "applicable": true,
            "notes": "Paid to the APS office; non-refundable. Subject to government updates."
          }
        ]
      },
      {
        ...
        "items": [
          {
            ...
            "currency": "EUR",
            "applicable": true,
            "notes": "Most public universities charge no tuition; Baden-Württemberg charges non-EU students tuition of approximately €1,500/semester (separate from the semester contribution) — confirm."
          },
          {
        ...
        "items": [
          {
            ...
            "currency": "EUR",
            "applicable": true,
            "notes": "Monthly release €992/month; subject to government updates"
          },
          {
          ...
          },
          {
            ...
            "currency": "EUR",
            "applicable": true,
            "notes": "Statutory student plan (TK/AOK/Barmer) or accepted private; premium updated periodically based on official sources"
          }
        ]
      },
      {
        ...
        "items": [
          {
            ...
            "range": "₹85,000 (public institutions) / ₹15,000 (private institutions)",
            "notes": "Service package dependent; institution type determines the tier"
          },
          {
            "label": "Flight / travel",
            "range": "Varies",
