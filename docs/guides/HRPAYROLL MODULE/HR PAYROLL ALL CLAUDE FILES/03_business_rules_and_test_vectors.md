...
### 1a. Late deduction slab (K) — configured bands + formula fallback
Use configured `slab_table` from Late Policy (Config). Default company bands:
...
Above the highest configured `max`, deduction continues uncapped:

`1.0 + floor((Late Marks − 1) / 3) × 0.5` (e.g. 31 → 6.0, 99 → 17.0).

Empty or invalid `slab_table` → default bands above + warning log.
...
| TV03 | Late slab boundary =3 (1.0 ded) | 30 | 30000 | 15000 | 0 | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 1 | 0 | **29** | 1000 | 29000 | 1800 | 0 | **27200** |
| TV04 | Late slab boundary =4 (1.5) | 30 | 30000 | 15000 | 0 | 0 | 4 | 0 | 0 | 0 | 0 | 0 | 1.5 | 0 | **28.5** | 1000 | 28500 | 1800 | 0 | **26700** |
| TV05 | Late slab =6 (1.5) | 30 | 30000 | 15000 | 0 | 0 | 6 | 0 | 0 | 0 | 0 | 0 | 1.5 | 0 | **28.5** | 1000 | 28500 | 1800 | 0 | **26700** |
| TV06 | Late slab =7 (2.0) | 30 | 30000 | 15000 | 0 | 0 | 7 | 0 | 0 | 0 | 0 | 0 | 2 | 0 | **28** | 1000 | 28000 | 1800 | 0 | **26200** |
| TV07 | Late slab =27 (5.0) | 30 | 30000 | 15000 | 0 | 0 | 27 | 0 | 0 | 0 | 0 | 0 | 5 | 0 | **25** | 1000 | 25000 | 1800 | 0 | **23200** |
| TV08 | Late slab =28 (5.5 formula) | 30 | 30000 | 15000 | 0 | 0 | 28 | 0 | 0 | 0 | 0 | 0 | 5.5 | 0 | **24.5** | 1000 | 24500 | 1800 | 0 | **22700** |
| TV09 | Late slab huge =45 (8.0 formula) | 30 | 30000 | 15000 | 0 | 0 | 45 | 0 | 0 | 0 | 0 | 0 | 8 | 0 | **22** | 1000 | 22000 | 1800 | 0 | **20200** |
...
| TV22 | Combined: late7 mis3 ul1 sand1 | 30 | 42000 | 21000 | 0 | 0 | 7 | 3 | 1 | 1 | 0 | 0 | 2 | 0.5 | **24.5** | 1400 | 34300 | 1800 | 0 | **32500** |
...
| TV29 | 31-day cycle, half-ish deductions | 31 | 46500 | 23250 | 0 | 0 | 10 | 4 | 0 | 0 | 0 | 0 | 2.5 | 1 | **27.5** | 1500 | 41250 | 1800 | 0 | **39450** |
| TV30 | Everything at once (stress) | 30 | 50000 | 25000 | 3 | 2 | 13 | 6 | 1 | 2 | 1 | 2 | 3 | 2 | **19** | 1666.67 | 31667 | 1800 | 0 | **34367** |
