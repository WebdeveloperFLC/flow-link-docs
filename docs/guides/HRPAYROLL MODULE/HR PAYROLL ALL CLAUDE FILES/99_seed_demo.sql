...
begin
  ...
  insert into employees(org_id,emp_code,full_name,gender,dob,mobile,email,addr_current,addr_permanent,emergency,
    ...
    values (v_org,'FL-1042','Isha Sikligar','Female','1994-03-14','+91 98250 11223','isha.s@futurelink.in',
     ...
     42000,21000,8400,1600,11000,0,0,true,'GJ/VAD/0099123','100928374651',false,'31009912345') returning id into v_isha;
  ...
  insert into role_permissions(org_id,role,can_view,can_apply,can_approve,can_override,can_export,can_configure,can_manage_emp,screens) values
    (v_org,'Super Admin', true,true,true,true,true,true,true,  '{}'::jsonb),
    (v_org,'Admin',       true,true,true,true,true,true,true,  '{}'::jsonb),
    (v_org,'HR Manager',  true,true,true,true,true,false,true, '{}'::jsonb),
    (v_org,'HR Executive',true,true,true,false,true,false,true,'{}'::jsonb),
    (v_org,'Manager',     true,true,true,false,false,false,false,'{}'::jsonb),
    (v_org,'Employee',    true,true,false,false,false,false,false,'{}'::jsonb);
