...
| **Incentive Platform Spec (draft — pending approval)** | [incentive-platform-spec-v1.md](./incentive-platform-spec-v1.md) | Product / Finance · **In-app:** `/guides/incentive-platform-spec` |
