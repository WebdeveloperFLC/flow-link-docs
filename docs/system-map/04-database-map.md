...
### Email
`email_templates`, `email_threads`, `email_send_log`, `email_send_state`, `email_events`, `email_read_receipts`, `email_attachments`, `email_unsubscribe_tokens`, `app_email_logs`, `notification_settings`.
