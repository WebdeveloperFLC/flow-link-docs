...
const GERMAN = [
  ...
  },
  {
    ...
    jsonFile: "coaching-german-language-a1-crash.json",
    service: "German Language A1 Crash Course",
    sub_service: "European Languages",
    display_order: 215,
    family: "German Language",
    displayName: "German Language A1 Crash Course",
    shortDescription: "CEFR A1 · Intensive 4–6 weeks · Exam/deadline focus",
    policySummary: "Crash A1 only when diagnostic gap is realistic. Never guarantee Goethe/telc pass.",
    duration: "4–6 weeks",
    batchType: "Crash",
    learningLevel: "Beginner",
    phase: "C",
    checklistSlug: "german-language-a1-crash",
    checklistHtml: "/specimens/coaching/german-language-a1-crash-checklist.html",
  },
  {
  ...
  {
    id: "b2000001-0001-4000-8000-0000000000c7",
    jsonFile: "coaching-german-language-b2-regular.json",
    service: "German Language B2 Regular",
    sub_service: "European Languages",
    display_order: 255,
    family: "German Language",
    displayName: "German Language B2 Regular",
    shortDescription: "CEFR B2 · Regular batch · Advanced study/work prep",
    policySummary: "B2 for advanced university pathways, skilled roles, and Opportunity Card language points.",
    duration: "12–14 weeks",
    learningLevel: "Advanced",
    phase: "C",
    checklistSlug: "german-language-b2-regular",
    checklistHtml: "/specimens/coaching/german-language-b2-regular-checklist.html",
  },
];
