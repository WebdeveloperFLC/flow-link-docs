...
export const ACCT_MODULES: AcctModuleDef[] = [
  ...
  { key: "trust",                  label: "Student Trust (pass-through funds)", dependencies: ["clients_link", "coa"] },
  { key: "payroll",                label: "Payroll accounting", dependencies: ["coa", "journals"] },
  ...
  { key: "collection_categories",  label: "Collection categories (payment purposes)", dependencies: ["coa"], adminOnly: true },
  { key: "payment_purpose_report", label: "Reports — Payment purpose", dependencies: ["trust", "ar"] },
...
export const ACCT_ROLE_DEFAULTS: Record<AccountingRole, AcctPermissionMap> = {
  ...
  ACCOUNTANT: {
    dashboard: VIEW, coa: EDIT, journals: EDIT, ap: EDIT, ar: EDIT, trust: EDIT, payroll: EDIT, vendors: EDIT,
    clients_link: EDIT, bank: EDIT, card_recon: EDIT, petty_cash: EDIT, reimbursements: EDIT,
    intercompany: VIEW, entities: VIEW, masters: EDIT, collection_categories: EDIT, payment_purpose_report: VIEW,
    documents: EDIT, approvals: VIEW, tax: VIEW,
  ...
  AUDITOR: {
    dashboard: VIEW, coa: VIEW, journals: EDIT, ap: VIEW, ar: VIEW, trust: VIEW, payroll: VIEW, vendors: VIEW,
    clients_link: VIEW, bank: VIEW, card_recon: VIEW, petty_cash: VIEW, reimbursements: VIEW,
    intercompany: VIEW, entities: VIEW, masters: VIEW, collection_categories: VIEW, payment_purpose_report: VIEW,
    documents: VIEW, approvals: EDIT, tax: VIEW,
    reports_reconciliation: VIEW, reports_consolidated: VIEW, reports_financials: VIEW,
    fraud: VIEW, ai: VIEW, owners: NONE, onboarding: VIEW, users: NONE, access_admin: NONE,
  },
  FINAL_AUDITOR: {
    dashboard: VIEW, coa: VIEW, journals: EDIT, ap: EDIT, ar: EDIT, trust: EDIT, payroll: EDIT, vendors: VIEW,
    clients_link: VIEW, bank: VIEW, card_recon: VIEW, petty_cash: VIEW, reimbursements: VIEW,
    intercompany: VIEW, entities: VIEW, masters: VIEW, collection_categories: VIEW, payment_purpose_report: VIEW,
    documents: VIEW, approvals: EDIT, tax: VIEW,
    reports_reconciliation: VIEW, reports_consolidated: VIEW, reports_financials: VIEW,
  ...
  BRANCH_MANAGER: {
    dashboard: VIEW, coa: VIEW, journals: VIEW, ap: VIEW, ar: VIEW, trust: VIEW, payroll: VIEW, vendors: VIEW,
    clients_link: VIEW, bank: VIEW, card_recon: VIEW, petty_cash: VIEW, reimbursements: VIEW,
    intercompany: VIEW, entities: VIEW, masters: VIEW, collection_categories: VIEW, payment_purpose_report: VIEW,
    documents: VIEW, approvals: EDIT, tax: VIEW,
    reports_reconciliation: VIEW, reports_consolidated: VIEW, reports_financials: VIEW,
  ...
  COMPLIANCE_OFFICER: {
    ...
    clients_link: VIEW, bank: VIEW, card_recon: VIEW, petty_cash: VIEW, reimbursements: VIEW,
    intercompany: VIEW, entities: VIEW, masters: VIEW, collection_categories: VIEW, payment_purpose_report: VIEW,
    documents: EDIT, approvals: VIEW, tax: EDIT,
    reports_reconciliation: VIEW, reports_consolidated: VIEW, reports_financials: VIEW,
