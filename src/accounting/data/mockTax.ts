...
export type FilingStatus = "FILED" | "PENDING" | "OVERDUE" | "DUE_SOON" | "NOT_APPLICABLE";

export type NoticeStatus = "OPEN" | "RESPONDED" | "RESOLVED" | "ESCALATED" | "CLOSED";
...
const RAW_PERIODS: Omit<TaxPeriod, "daysUntilDue" | "daysOverdue">[] = [
  ...
  },
  {
    ...
    taxAmount: 42300,
    currency: "CAD",
    filedDate: "2024-07-28",
    referenceNumber: "CRA-2024-Q2-78432",
    filedBy: "Jennifer Walsh",
  },
  {
    id: "tp-3",
    entity: "Future Link Canada HQ",
  ...
  },
  {
    ...
    referenceNumber: "GSTIN-2024-SEP-45123",
    filedBy: "Raj Kumar",
  },
  {
    id: "tp-8",
  ...
  },
  {
    ...
    taxTypeName: "Professional Tax — Mumbai",
    period: "October 2024",
    periodStart: "2024-10-01",
    periodEnd: "2024-10-31",
    dueDate: "2024-11-30",
  ...
  // USA — Future Link USA Corp
  {
    ...
    country: "US",
    taxType: "SALES_TAX",
    taxTypeName: "Sales Tax — New York",
    period: "Q3 2024",
    periodStart: "2024-07-01",
    periodEnd: "2024-09-30",
    dueDate: "2024-11-15",
  ...
  },
  {
    ...
    country: "US",
    taxType: "CORPORATE_TAX",
    taxTypeName: "Federal Corporate Tax",
    period: "FY2023",
    periodStart: "2023-01-01",
    periodEnd: "2023-12-31",
    dueDate: "2024-04-15",
  ...
  },
  {
    ...
    referenceNumber: "FTA-2024-Q2-89234",
