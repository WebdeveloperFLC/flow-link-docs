import type {
  ...
  ApplicationHoldReasonCode,
  ApplicationLifecycleStatus,
} from "./types";

/** Application Lifecycle status labels (internal enum: qualification_lifecycle_status) */
export const APPLICATION_LIFECYCLE_STATUS_LABELS: Record<ApplicationLifecycleStatus, string> = {
  DRAFT: "Draft",
  ACTIVE: "Active",
  ON_HOLD: "On Hold",
  COMPLETED: "Completed",
...
export const APPLICATION_LIFECYCLE_BADGE_CLASS: Record<ApplicationLifecycleStatus, string> = {
...
export const HOLD_REASON_LABELS: Record<ApplicationHoldReasonCode, string> = {
