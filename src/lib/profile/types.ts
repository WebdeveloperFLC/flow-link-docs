...
export const ENGLISH_TEST_TYPES = ["IELTS", "PTE", "TOEFL", "CELPIP", "Duolingo"] as const;
export type EnglishTestType = (typeof ENGLISH_TEST_TYPES)[number];

export const APTITUDE_TEST_TYPES = ["GRE", "GMAT", "SAT", "ACT"] as const;
export type AptitudeTestType = (typeof APTITUDE_TEST_TYPES)[number];
...
export interface ProfileEnglishTestEntry {
  readonly test_type: EnglishTestType;
...
export interface ProfileAptitudeTestEntry {
  readonly test_type: AptitudeTestType;
  readonly status: ProfileTestStatus | null;
  readonly overall: string | null;
  readonly test_date: string | null;
  readonly sections: Readonly<Record<string, string>>;
...
export interface ProfileTests {
  readonly active_english_test: EnglishTestType | null;
...
export interface ProfileEditState {
  ...
  selectedEnglishTest: EnglishTestType | null;
  selectedAptitudeTest: AptitudeTestType | null;
  ...
  tests: {
    active_english_test: EnglishTestType | null;
