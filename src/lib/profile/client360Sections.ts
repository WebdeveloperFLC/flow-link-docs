...
export const CLIENT_360_SECTIONS: readonly Client360SectionDefinition[] = [
  ...
  { id: "services", label: "Client Services", phase: 1, detailTabId: "commercial", readOnly: true },
  ...
  { id: "comms", label: "Comms", phase: 1, detailTabId: "comms", readOnly: true },
  ...
  { id: "activity", label: "Activity Log", phase: 1, detailTabId: "activity", readOnly: true },
] as const;
