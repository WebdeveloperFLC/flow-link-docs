...
export function OfficialResourcesPanel(props: CommonProps & (ProgramProps | InstitutionProps)) {
  const {
    title = props.scope === "institution" ? "Official resources" : "Official resources",
  ...
  if (props.scope === "institution") {
    const { institutionResources: r, onInstitutionChange, onInstitutionSave } = props;
  ...
  const { resources, onChange, onSave } = props;
