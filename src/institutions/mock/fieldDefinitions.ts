...
export const FIELD_DEFINITIONS: Record<Scope, FieldDefinition[]> = {
  ...
  promotion: [
    ...
    { key: "promo_type", label: "Type", type: "select", group: "Basics", options: ["bonus_commission", "fee_waiver", "seasonal", "intake_offer", "country_offer"] },
    { key: "valid_from", label: "Valid from", type: "date", group: "Validity" },
    { key: "valid_to", label: "Valid to", type: "date", group: "Validity" },
    { key: "target_countries", label: "Eligible countries", type: "multiselect", group: "Eligibility", options: COUNTRY_OPTIONS },
    { key: "target_intakes", label: "Eligible intakes", type: "multiselect", group: "Eligibility", options: INTAKE_OPTIONS },
    { key: "bonus_amount", label: "Bonus amount", type: "number", group: "Payout" },
    { key: "bonus_unit", label: "Bonus unit", type: "select", group: "Payout", options: ["percent", "fixed_cad"] },
    { key: "linked_agreement_id", label: "Linked agreement id", type: "text", group: "Links" },
    { key: "linked_commission_rule_id", label: "Linked commission rule id", type: "text", group: "Links" },
