    ...
    <AppLayout>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-4">
          <LeadModeToggle value={mode} onChange={setMode} disabled={!!leadId || isClientPhase} />
          {leadId && !isClientPhase && (
            <span className="text-xs text-muted-foreground">Mode locked after first save</span>
          )}
        </div>
        ...
        {isClientPhase && leadId && leadNumber && (
